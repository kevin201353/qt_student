...
public:
    ...
    QLabel *RoomNumlabel;
    QLabel *SeatNumlabel;
    QComboBox *RoomNumcomboBox;
    QComboBox *SeatNumcomboBox;
    QFrame *title_bar;
    QPushButton *btnExit;
    ...
    void setupUi(QWidget *SetForm)
    {
        ...
        SetForm->resize(724, 530);
        SetTabWidget = new QTabWidget(SetForm);
        SetTabWidget->setObjectName(QStringLiteral("SetTabWidget"));
        SetTabWidget->setGeometry(QRect(9, 39, 711, 451));
        QSizePolicy sizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(SetTabWidget->sizePolicy().hasHeightForWidth());
        SetTabWidget->setSizePolicy(sizePolicy);
        tab = new QWidget();
        tab->setObjectName(QStringLiteral("tab"));
        IPgroupBox = new QGroupBox(tab);
        IPgroupBox->setObjectName(QStringLiteral("IPgroupBox"));
        IPgroupBox->setGeometry(QRect(9, 9, 601, 179));
        ...
        DNSgroupBox->setGeometry(QRect(10, 200, 601, 179));
        ...
        ServerIPlabel->setGeometry(QRect(9, 40, 81, 20));
        ...
        ServerIPlineEdit->setGeometry(QRect(111, 40, 125, 22));
        RoomNumlabel = new QLabel(tab_2);
        RoomNumlabel->setObjectName(QStringLiteral("RoomNumlabel"));
        RoomNumlabel->setGeometry(QRect(10, 90, 84, 20));
        RoomNumlabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        SeatNumlabel = new QLabel(tab_2);
        SeatNumlabel->setObjectName(QStringLiteral("SeatNumlabel"));
        SeatNumlabel->setGeometry(QRect(10, 137, 84, 20));
        SeatNumlabel->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);
        RoomNumcomboBox = new QComboBox(tab_2);
        RoomNumcomboBox->setObjectName(QStringLiteral("RoomNumcomboBox"));
        RoomNumcomboBox->setGeometry(QRect(120, 90, 131, 28));
        SeatNumcomboBox = new QComboBox(tab_2);
        SeatNumcomboBox->setObjectName(QStringLiteral("SeatNumcomboBox"));
        SeatNumcomboBox->setGeometry(QRect(120, 130, 131, 28));
        SetTabWidget->addTab(tab_2, QString());
        title_bar = new QFrame(SetForm);
        title_bar->setObjectName(QStringLiteral("title_bar"));
        title_bar->setGeometry(QRect(0, 0, 731, 31));
        title_bar->setFrameShape(QFrame::StyledPanel);
        title_bar->setFrameShadow(QFrame::Raised);
        btnExit = new QPushButton(title_bar);
        btnExit->setObjectName(QStringLiteral("btnExit"));
        btnExit->setGeometry(QRect(697, 9, 16, 13));
        btnExit->setStyleSheet(QStringLiteral("border-image: url(:/image1/x.png);"));
        layoutWidget = new QWidget(SetForm);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(9, 497, 711, 32));
        ...
        SetTabWidget->setCurrentIndex(1);
    ...
    void retranslateUi(QWidget *SetForm)
    {
        ...
        RoomNumlabel->setText(QApplication::translate("SetForm", "TextLabel", Q_NULLPTR));
        SeatNumlabel->setText(QApplication::translate("SetForm", "TextLabel", Q_NULLPTR));
