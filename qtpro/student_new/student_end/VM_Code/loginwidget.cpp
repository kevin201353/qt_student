...
//    g_Loadingwnd = NULL;
//    g_Loadingwnd = new LoadingFrame(this);
//    g_Loadingwnd->hide();
    //createPipe();
    //PIPE_WAIT("0");
    if(g_pLog == NULL)
    ...
    //g_LoadingFrame = new LoadingFrame(this);
...
void LoginWidget::keyPressEvent(QKeyEvent *event)
{
    ...
    {
        m_pSetRoomSeat->SetRoomSeatText(g_strRoomNum,g_strSeatNum);
        m_pSetRoomSeat->show();
    }
}
