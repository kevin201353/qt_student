...
int myJson::WriteJson(int tmp, const char *Father, const char *Key)
{
//    if(!m_WriteValue.isMember(Father))
//    {
//        m_WriteValue[Father] = m_WriteValue_2;
//    }
//    else
    {
       // m_WriteValue_2[Key] = tmp;
        m_WriteValue[Father][Key] = tmp;
    }
}
int myJson::WriteJson(const char* tmp, const char *Father, const char *Key)
{
//    if(!m_WriteValue.isMember(Father))
//    {
//        m_WriteValue[Father] = m_WriteValue_2;
